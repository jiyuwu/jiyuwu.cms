...
namespace JIYUWU.Core.Extension
{
    public static class HttpContextExtension
    {
        ...
        /// <returns></returns>
        public static string Request(this Microsoft.AspNetCore.Http.HttpContext context, string parameter)
        {
            try
            {
                if (context == null)
        ...
        public static T Request<T>(this Microsoft.AspNetCore.Http.HttpContext context, string parameter) where T : class
        {
            return context.RequestString(parameter)?.DeserializeObject<T>();
        }
        public static string RequestString(this Microsoft.AspNetCore.Http.HttpContext context, string parameter)
        {
        ...
        public static UserAgent GetAgentType(this Microsoft.AspNetCore.Http.HttpContext context)
        {
            ...
            {
                return  Common.UserAgent.IOS;
            }
            if (agent.Contains("windows"))
            {
                return Common.UserAgent.Windows;
            }
            return Common.UserAgent.Android;
        ...
        public static string GetRequestParameters(this Microsoft.AspNetCore.Http.HttpContext context)
        {
