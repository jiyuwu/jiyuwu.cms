...
{
    [Entity(TableCnName = "审批节点配置",TableName = "Base_WorkFlowStep", DBServer = "BaseDbContext")]
    public partial class Base_WorkFlowStep : BaseEntity
    {
        /// <summary>
       ///
       /// </summary>
       ...
       ///审核通过Api
       /// </summary>
       [Display(Name ="审核通过Api")]
       [MaxLength(2000)]
       [Column(TypeName="nvarchar(2000)")]
       [Editable(true)]
       public string AuditAgreeApi { get; set; }

       /// <summary>
       ///审核通过sql
       /// </summary>
       [Display(Name ="审核通过sql")]
       [MaxLength(4000)]
       [Column(TypeName="nvarchar(4000)")]
       [Editable(true)]
       public string AuditAgreeSql { get; set; }

       /// <summary>
       ///审核未通过api
       /// </summary>
       [Display(Name ="审核未通过api")]
       [MaxLength(2000)]
       [Column(TypeName="nvarchar(2000)")]
       [Editable(true)]
       public string AuditRefuseApi { get; set; }

       /// <summary>
       ///审核未通过sql
       /// </summary>
       [Display(Name ="审核未通过sql")]
       [MaxLength(4000)]
       [Column(TypeName="nvarchar(4000)")]
       [Editable(true)]
       public string AuditRefuseSql { get; set; }

       /// <summary>
       ///审核驳回api
       /// </summary>
       [Display(Name ="审核驳回api")]
       [MaxLength(2000)]
       [Column(TypeName="nvarchar(2000)")]
       [Editable(true)]
       public string AuditBackApi { get; set; }

       /// <summary>
       ///审核驳回sql
       /// </summary>
       [Display(Name ="审核驳回sql")]
       [MaxLength(4000)]
       [Column(TypeName="nvarchar(4000)")]
       [Editable(true)]
       public string AuditBackSql { get; set; }
